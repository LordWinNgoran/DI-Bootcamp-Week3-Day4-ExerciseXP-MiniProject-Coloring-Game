 ...
 * @description: Welcome to Coloring Squares.Your task is to build a coloring game similar 
 * to the working project above.You will need to use HTML, CSS and JS to accomplish this task
 * @param: 21 distinct colors
 * @param: 1 button
 * @param: 1 area for drawing compose of 1440 squares
 * Date : 07/01/2023
 */
...
// We set the default for no margin and no padding
